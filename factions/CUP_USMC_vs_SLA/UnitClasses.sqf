...
"CUP_I_RACS_Soldier", "CUP_I_RACS_Soldier", "CUP_I_RACS_GL", "CUP_I_RACS_MMG"];
...
switch (_enemyFrequency) do {
	case 1: {
		...
		"CUP_O_Ural_SLA", "CUP_O_Ural_Open_SLA", "CUP_O_Ural_Empty_SLA", "CUP_O_Ural_ZU23_SLA", "CUP_O_BM21_SLA", "CUP_O_Ural_Refuel_SLA", "CUP_O_Ural_Repair_SLA", "CUP_O_Ural_Reammo_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BRDM2_ATGM_SLA", "CUP_O_BRDM2_HQ_SLA", "CUP_O_BMP2_SLA", "CUP_O_BMP_HQ_sla", "CUP_O_BMP2_AMB_sla", "CUP_O_ZSU23_SLA", "CUP_O_T72_SLA"];
		a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = [
		"CUP_I_LR_MG_RACS", "CUP_I_LR_MG_RACS", "CUP_I_LR_Transport_RACS", "CUP_I_LR_Transport_RACS", "CUP_I_LR_Ambulance_RACS", "CUP_I_M113_RACS", "CUP_I_M113_Med_RACS", "CUP_I_M163_RACS", "CUP_I_T72_RACS"];
	};
	case 2: {
		// Some (4-6)
		a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses = [
...
a3e_arr_Escape_InfantryTypes = [
	"CUP_O_SLA_Soldier", "CUP_O_SLA_Soldier", "CUP_O_SLA_Soldier", "CUP_O_SLA_Soldier_GL", "CUP_O_SLA_Soldier_Backpack", "CUP_O_SLA_Soldier_Backpack", "CUP_O_SLA_Soldier_AAT", "CUP_O_SLA_Soldier_AMG", "CUP_O_SLA_Soldier_LAT", "CUP_O_SLA_Engineer", "CUP_O_SLA_Engineer", "CUP_O_SLA_Soldier_MG", "CUP_O_SLA_Soldier_AR", "CUP_O_SLA_Soldier_AR", "CUP_O_SLA_Medic", "CUP_O_SLA_Medic", "CUP_O_SLA_Medic", "CUP_O_SLA_Soldier_SL", "CUP_O_SLA_Officer", "CUP_O_SLA_Spotter", "CUP_O_SLA_Sniper", "CUP_O_SLA_Sniper_KSVK", "CUP_O_SLA_Sniper_SVD_Night", "CUP_O_SLA_Soldier_AKS_Night", "CUP_O_SLA_Soldier_AKS_74_GOSHAWK"
];
a3e_arr_Escape_InfantryTypes_AT = ["CUP_O_SLA_Soldier_AT", "CUP_O_SLA_Soldier_AT"];
a3e_arr_Escape_InfantryTypes_AA = ["CUP_O_SLA_Soldier_AA"];

a3e_arr_Escape_InfantryTypes_Ind = [
	"CUP_I_RACS_Soldier", "CUP_I_RACS_Soldier", "CUP_I_RACS_Soldier", "CUP_I_RACS_Officer", "CUP_I_RACS_Medic", "CUP_I_RACS_Medic", "CUP_I_RACS_SL", "CUP_I_RACS_GL", "CUP_I_RACS_MMG", "CUP_I_RACS_Sniper", "CUP_I_RACS_Engineer", "CUP_I_RACS_Engineer"
];
a3e_arr_Escape_InfantryTypes_AT_Ind = ["CUP_I_RACS_Soldier_MAT", "CUP_I_RACS_Soldier_MAT"];
a3e_arr_Escape_InfantryTypes_AA_Ind = ["CUP_I_RACS_Soldier_AA"];
a3e_arr_recon_InfantryTypes = [
	"CUP_O_SLA_SpecOps", "CUP_O_SLA_SpecOps", "CUP_O_SLA_SpecOps", "CUP_O_SLA_SpecOps", "CUP_O_SLA_SpecOps_TL", "CUP_O_SLA_SpecOps_MG", "CUP_O_sla_SpecOps_LAT", "CUP_O_sla_SpecOps_Demo"
];
a3e_arr_recon_I_InfantryTypes = [
	"CUP_I_RACS_RoyalCommando", "CUP_I_RACS_RoyalCommando", "CUP_I_RACS_RoyalCommando", "CUP_I_RACS_RoyalCommando", "CUP_I_RACS_RoyalMarksman", "CUP_I_RACS_RoyalGuard"
];

// random array. A roadblock has a manned vehicle. This array contains possible manned vehicles (can be of any kind, like cars, armored and statics).
a3e_arr_Escape_RoadBlock_MannedVehicleTypes = [
"CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BRDM2_SLA", "CUP_O_BRDM2_ATGM_SLA", "CUP_I_DSHKM_MiniTriPod_AAF", "CUP_I_KORD_high_AAF", "CUP_I_AGS_AAF", "CUP_I_Metis_AAF", "CUP_I_SPG9_AAF"];
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = [
"CUP_I_LR_MG_RACS", "CUP_I_LR_MG_RACS", "CUP_I_LR_MG_RACS", "CUP_I_LR_MG_RACS", "CUP_I_M113_RACS", "CUP_I_M113_RACS", "CUP_I_DSHKM_MiniTriPod_AAF", "CUP_I_KORD_high_AAF", "CUP_I_AGS_AAF", "CUP_I_Metis_AAF", "CUP_I_SPG9_AAF"];

// random array. vehicle classes (preferrably trucks) transporting enemy reinforcements.
a3e_arr_Escape_ReinforcementTruck_vehicleClasses = [
"CUP_O_BRDM2_SLA"// 3, "CUP_O_Ural_SLA"// 12, "CUP_O_Ural_SLA"// 12, "CUP_O_Ural_Open_SLA"];// 12
];
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = [
"CUP_I_LR_Transport_RACS"// 5, "CUP_I_LR_Transport_RACS"// 5, "CUP_I_M113_RACS"];// 11
];
// random array. Motorized search groups are sometimes sent to look for you. This array contains possible class definitions for the vehicles.
a3e_arr_Escape_MotorizedSearchGroup_vehicleClasses = [
"CUP_O_Ural_SLA", "CUP_O_Ural_Open_SLA", "CUP_I_LR_Transport_RACS", "CUP_I_LR_MG_RACS", "CUP_O_BMP_HQ_sla", "CUP_O_BMP2_SLA", "CUP_O_BRDM2_SLA", "CUP_I_M113_RACS"];
...
a3e_arr_ComCenParkedVehicles = [
	"I_G_Offroad_01_repair_F", "CUP_I_LR_Transport_RACS", "CUP_I_LR_MG_RACS", "CUP_I_LR_Ambulance_RACS", "CUP_O_Ural_SLA", "CUP_O_Ural_Open_SLA", "CUP_O_Ural_Refuel_SLA", "CUP_O_Ural_Repair_SLA", "CUP_O_Ural_Reammo_SLA", "CUP_O_Ural_ZU23_SLA", "I_G_Offroad_01_armed_F", "CUP_B_MH6J_USA"
];
...
"CUP_I_DSHKM_AAF", "CUP_I_DSHKM_MiniTriPod_AAF", "CUP_I_KORD_AAF", "CUP_I_KORD_high_AAF", "CUP_I_AGS_AAF", "CUP_I_Metis_AAF", "CUP_I_SPG9_AAF", "CUP_I_Igla_AA_pod_AAF"];
// An ammo depot have one parked and empty vehicle of the following possible types.
a3e_arr_Escape_AmmoDepot_ParkedVehicleClasses = [
"I_G_Offroad_01_repair_F", "CUP_I_LR_Transport_RACS", "CUP_I_LR_MG_RACS", "CUP_I_LR_Ambulance_RACS", "CUP_O_Ural_SLA", "CUP_O_Ural_Open_SLA", "CUP_O_Ural_Refuel_SLA", "CUP_O_Ural_Repair_SLA", "CUP_O_Ural_Reammo_SLA", "CUP_O_BRDM2_HQ_SLA", "I_G_Offroad_01_armed_F"];

// random array. Types of helicopters to spawn
a3e_arr_O_attack_heli = [
"CUP_O_Ka50_AA_SLA", "CUP_O_Ka50_SLA", "CUP_O_Mi24_D_Dynamic_SLA"];
a3e_arr_O_transport_heli = [
"CUP_O_Mi8_SLA_1", "CUP_O_Mi8_SLA_2", "CUP_O_MI6T_SLA"];
a3e_arr_O_pilots = [
"CUP_O_SLA_Pilot"];
a3e_arr_I_transport_heli = [
"CUP_I_CH47F_RACS", "CUP_I_SA330_Puma_HC1_RACS", "CUP_I_SA330_Puma_HC2_RACS", "CUP_I_UH60L_RACS", "CUP_I_UH60L_FFV_RACS", "CUP_I_UH60L_Unarmed_Racs", "CUP_I_UH60L_Unarmed_FFV_Racs"];
a3e_arr_I_pilots = [
"CUP_I_RACS_Pilot"];
...
a3e_arr_Scopes = [
"CUP_optic_Kobra", "CUP_optic_PSO_1", "CUP_optic_PSO_3", "CUP_optic_PechenegScope", "CUP_optic_SB_3_12x50_PMII", "CUP_optic_LeupoldMk4", "CUP_optic_HoloBlack", "CUP_optic_HoloWdl", "CUP_optic_HoloDesert", "CUP_optic_Eotech533", "CUP_optic_Eotech533Grey", "CUP_optic_CompM4", "CUP_optic_SUSAT", "CUP_optic_ACOG", "CUP_optic_RCO", "CUP_optic_RCO_desert", "CUP_optic_ElcanM145", "CUP_optic_ELCAN_SpecterDR", "CUP_optic_LeupoldMk4_CQ_T", "CUP_optic_ZDDot"];
a3e_arr_Scopes_SMG = [
"CUP_optic_Kobra", "CUP_optic_Eotech533", "CUP_optic_ZDDot"];
a3e_arr_Scopes_Sniper = [
"CUP_optic_PSO_1", "CUP_optic_PSO_3", "CUP_optic_LeupoldMk4", "CUP_optic_SB_3_12x50_PMII", "CUP_optic_LeupoldMk4_10x40_LRT_Desert"];
a3e_arr_NightScopes = [
"CUP_optic_NSPU", "CUP_optic_AN_PVS_10", "CUP_optic_AN_PVS_4"];
a3e_arr_TWSScopes = [
"CUP_optic_GOSHAWK", "CUP_optic_AN_PAS_13c2", "CUP_optic_AN_PAS_13c1"];
...
"CUP_I_MH6J_RACS", "CUP_I_UH60L_Unarmed_FFV_Racs"];
...
"CUP_I_RHIB_RACS", "CUP_I_RHIB2Turret_RACS"];
...
// //// //// //// //// ////////////////////////////////////////////////
a3e_arr_CASplane = [
"CUP_O_Su25_SLA", "CUP_O_SU34_AGM_SLA", "CUP_O_SU34_LGB_SLA"];
...
"Land_UWreck_MV22_F", "Land_Wreck_Plane_Transport_01_F", "Land_Wreck_Heli_Attack_01_F"];
a3e_arr_CrashSiteCrew = [
"CUP_B_US_Pilot", "CUP_B_US_Pilot_Light"];
a3e_arr_CrashSiteWrecksCar = [
	"Land_Wreck_HMMWV_F", "Land_Wreck_Hunter_F", "Land_Wreck_Slammer_F"
];
a3e_arr_CrashSiteCrewCar = [
"CUP_B_USMC_Crew", "CUP_B_USMC_SpecOps_SD"];
